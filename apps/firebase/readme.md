...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp firebase-app` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run firebase-app:deploy` - Deploy this app to firebase
* `nx run firebase-app:serve` - Serve this app using the firebase emulator
* `nx run firebase-app:build` - Build all functions associated with this app
* `nx run firebase-app:test` - Test all functions associated with this app
* `nx run firebase-app:lint` - Lint all functions associated with this app
